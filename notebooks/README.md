...
## 4. Long-baseline oscillation probabilities [[`4_magnus_long_baseline.ipynb`](4_magnus_long_baseline.ipynb)]
...
## 5. Biprobability plots [[`5_magnus_biprobability.ipynb`](5_magnus_biprobability.ipynb)]
...
## 6. Oscillograms in Earth [[`6_magnus_oscillograms.ipynb`](6_magnus_oscillograms.ipynb)]
...
## 7. BSM: sterile neutrinos [[`7_magnus_bsm_sterile_nu.ipynb`](7_magnus_bsm_sterile_nu.ipynb)]
...
## 8. BSM: non-standard interactions [[`8_magnus_bsm_nsi.ipynb`](8_magnus_bsm_nsi.ipynb)]
...
## 9. BSM: Lorentz-invariance violation [[`9_magnus_bsm_liv.ipynb`](9_magnus_bsm_liv.ipynb)]
