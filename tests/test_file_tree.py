...
TREE = [
    ...
    ('img/anim_solar_nsi.gif', 'Animated: the Sun, with a non-standard interaction dialled up'),
    ('img/anim_sterile.gif', 'Animated: a sterile state as its mass splitting grows'),
    ('img/anim_wave.gif', 'Animated: a density crest travelling along the baseline'),
    ...
    ('notebooks/02_magnus_2nu_vacuum_matter.ipynb',
     'Two flavours, across seven matter profiles'),
    ('notebooks/03_magnus_3nu_vacuum_matter.ipynb',
     'The same, with three flavours and a CP phase'),
    ...
    ('notebooks/19_magnus_custom_hamiltonian.ipynb',
     'The H_func contract, and the vectorisation trick'),
    ...
    ('tests/test_palindrome.py', 'The palindromic-profile optimisation and its gate'),
