...
TREE = [
    ...
    ('notebooks/gen_shock_cost.py',
     'GENERATES external_shock_cost.json -- Figure 12, in two phases'),
    ...
    ('notebooks/shock_reference_scan.json',
     "Figure 12's frozen references, keyed at full precision, with both fingerprints"),
    ('notebooks/check_shock_adiabaticity.py',
     "Tests whether Figure 12's cost peak sits at the adiabatic crossover"),
