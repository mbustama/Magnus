...
TREE = [
    ...
    ('notebooks/external_speed_accuracy_const.json',
     'Figure 15, top panel: constant density, seven codes plus Magnus'),
    ('notebooks/external_earth_plane.json',
     'Figure 15, middle panel: a PREM chord at three flavors'),
    ('notebooks/external_prem_speed_accuracy_new.json',
     'Figure 15, bottom panel: the same chord at 3+1'),
    ...
    ('notebooks/gen_mp_reference.py',
     'GENERATES mp_reference_profile.json -- the mpmath referee for Figure 12'),
    ...
    ('notebooks/gen_shock_cost.py',
     'GENERATES external_shock_cost.json -- Figure 13, in two phases'),
    ('notebooks/external_shock_cost.json',
     'Cost of a fixed accuracy on the shock, 23 front widths, five arms'),
    ('notebooks/make_shock_scan_references.py',
     'FREEZES shock_reference_scan.json -- one DOP853 oracle per front width'),
    ('notebooks/shock_reference_scan.json',
     "Figure 13's frozen references, keyed at full precision, with both fingerprints"),
    ('notebooks/check_shock_adiabaticity.py',
     "Tests whether Figure 13's cost peak sits at the adiabatic crossover"),
    ('notebooks/check_shock_commutator.py',
     'Tests whether that peak is the commutator term, using order 2 as the control'),
    ('notebooks/gen_njobs_scaling.py',
     'GENERATES external_njobs_scaling.json -- Figure 11, one thread per process'),
    ('notebooks/external_njobs_scaling.json',
     'Wall clock against n_jobs on an Earth chord, nine arms at four scan sizes'),
    ...
    ('notebooks/retime_magnus_series.py',
     'RE-TIMES both codes in Figure 12; references and grids untouched'),
    ...
    ('resources/paper/AUDIT_2026-09-13.md',
     'The deep audit of 2026-09-13: 98 numbered items, ticked as they are done'),
    ('resources/paper/AUDIT_2026-09-13_replacements.md',
     'The replacement text the deep audit proposed, item by item'),
